...
同梱画像とサンプルは[`CC0 1.0`](ASSET_LICENSE.md)で自由に利用できます。ファイル一覧は
...
現在のソースツリーと0.4.0配布物には、第三者のキャラクター素材を含めていません。同梱ランタイム画像、
スプライトシートサンプル、画像生成用参考画像は[`CC0 1.0`](ASSET_LICENSE.md)で公開しています。
許可やクレジットなしで、複製、改変、再配布、販売、商用利用できます。独自画像へ差し替える場合は、
