...
| `smile.png` | Idle smile frame. | `01-03ac 基本-にっこり-口閉じ.png` |
...
Text frames are UTF-8 JSON commands. Binary frames are raw PCM audio playback
data for the device speaker.
